...
#include<stdio.h>
#include<stdlib.h>
//this program is werid:build again will failed after build sucessful.
// if build failed, replace libGLES_android.so and libOpenCL.so in app/src/main/jniLibs/armeabi-v7a
// with in app/src/main/jniLibs/armeabi-v7a/lib and build again will success,
// and replace the two files within app/src/main/jniLibs/armeabi-v7a/lib64 and build again will sucess
#define TAG OpenCL
